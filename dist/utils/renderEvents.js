...
export function renderDayEvents(dayEvents, eventsContainer, dayContainer) {
    ...
    if (dayEvents.length > 3) {
        ...
        setTimeout(() => {
            ...
            popoverTriggerEl === null || popoverTriggerEl === void 0 ? void 0 : popoverTriggerEl.addEventListener('show.bs.popover', () => renderDayEventsPopover(dayEvents, dayEventsPopover));
